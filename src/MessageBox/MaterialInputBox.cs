...
{
    public sealed class MaterialInputBox
    {
        ...
        public static string Show(string message, bool isRTL = false)
        {
        ...
        /// <param name="isRTL">(Optional) If true the MessageBox FlowDirection will be RightToLeft</param>
        public static string ShowError(string errorMessage, string errorTitle, bool isRTL = false)
        {
            try
            {
                using var msg = new InputBoxWindow
        ...
        /// <param name="isRTL">(Optional) If true the MessageBox FlowDirection will be RightToLeft</param>
        public static string ShowWarning(string warningMessage, bool isRTL = false)
        {
            try
            {
                using var msg = new InputBoxWindow
        ...
        /// <param name="isRTL">(Optional) If true the MessageBox FlowDirection will be RightToLeft</param>
        public static string ShowWarning(string warningMessage, string warningTitle, bool isRTL = false)
        {
            try
            {
                using var msg = new InputBoxWindow
