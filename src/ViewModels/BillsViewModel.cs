...
namespace Phony.ViewModels
{
    ...
    public class BillsViewModel : BindableBase
    {
        ...
        readonly Bills Message = Application.Current.Windows.OfType<Bills>().FirstOrDefault();
        ...
        {
            return SelectedClient is null ? false : (BillItemsMoves.Count > 0 || BillServicesMoves.Count > 0) && SelectedClient.Id > 0;
        }
        ...
        {
            return (DataGridSelectedBillItemMove is not null || !ByItem) && (DataGridSelectedBillServiceMove is not null || !ByService);
        }
