...
namespace Phony.ViewModels
{
    public class UsersViewModel : BindableBase
    {
        ...
        {
            return !string.IsNullOrWhiteSpace(Name) && UserId != 0 && DataGridSelectedUser is not null && !string.IsNullOrWhiteSpace(Password1) && !string.IsNullOrWhiteSpace(Password2);
        }
        ...
        {
            return DataGridSelectedUser is not null && DataGridSelectedUser.Id != 1;
        }
        ...
        {
            return DataGridSelectedUser is not null;
        }
